<script lang="ts">
  ...
  const {
    ...
    open,  // BYOS: Bring Your Own Store
  });
...
{#if $dialogOpen}
  <div use:melt={$portalled}>
    ...
    <div
      ...
      class="fixed left-1/2 top-1/2 z-50 w-[90vw] {sizeClasses[size]} -translate-x-1/2 -translate-y-1/2 rounded-xl bg-white p-5 shadow-dialog"
    >
